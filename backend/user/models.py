...
class CustomUser(AbstractUser):
    ...
    def save(self, *args, **kwargs):
        ...
        field_length_validator(self._password, 'Password',
            CustomUser.MIN_PASSWORD_LENGTH, CustomUser.MAX_PASSWORD_LENGTH)
        
        field_length_validator(self.username, 'Username',
            CustomUser.MIN_USERNAME_LENGTH, CustomUser.MAX_USERNAME_LENGTH)
        
        field_length_validator(self.email, 'Email',
            CustomUser.MIN_EMAIL_LENGTH, CustomUser.MAX_EMAIL_LENGTH)
